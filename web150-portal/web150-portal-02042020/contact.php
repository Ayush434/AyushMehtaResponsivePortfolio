...
<html lang="en">
 <head>
     <title>(Ayush Mehta): Responsive Website</title>
  <meta charset="utf-8" />
 ...
 <body>
     ...
     <h1>Ayush Mehta</h1>
        <nav class="topnav" id="myTopnav">
            ...
            <a href="/site61/ITC150-JavaScript/Timeofday/" target="_blank">Time Of Day</a>
            <a href="/site61/DailyGrind" target="_blank">Daily Grind</a>
            <a href="/site61/Domplay/" target="_blank">DOM Play</a>
           <a href="https://github.com/Ayush434" target="_blank">GitHub</a>
            <a href="https://www.linkedin.com/in/ayush-mehta-b8a614194/" target="_blank">LinkedIn</a>
   ...
   <main class="wrapper">
     ...
     -->  
       ...
       if(isset($_POST['Name'])){//show data
          ...
          */
          ...
          $to  = 'Ayush.mehta@seattlecolleges.edu';//put your email here
     ...
     <footer>
      <p><small>&copy; 2019 by <a href="contact.php">Contact (Ayush Mehta) </a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </main>
